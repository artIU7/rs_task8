...
@implementation ArtistVC (ShemaViewArray)
...
-(NSArray*) AddTreeArray {
  ...
  [bezierPath addCurveToPoint: CGPointMake(48.58, 64.71) controlPoint1: CGPointMake(47, 60.72) controlPoint2: CGPointMake(47.57, 62.83)];
  ...
  [bezierPath addCurveToPoint: CGPointMake(99.5, 130) controlPoint1: CGPointMake(86.89, 126.4) controlPoint2: CGPointMake(92.71, 130)];
  ...
  [bezierPath addCurveToPoint: CGPointMake(238.97, 78.55) controlPoint1: CGPointMake(241.93, 78) controlPoint2: CGPointMake(240.41, 78.19)];
  ...
  UIBezierPath* bezier3Path = [UIBezierPath bezierPath];
  [bezier3Path moveToPoint: CGPointMake(80, 250.5)];
  [bezier3Path addCurveToPoint: CGPointMake(141.5, 187.5) controlPoint1: CGPointMake(99.83, 244.67) controlPoint2: CGPointMake(139.9, 223.9)];
  [bezier3Path addCurveToPoint: CGPointMake(131.5, 140.5) controlPoint1: CGPointMake(143.1, 151.1) controlPoint2: CGPointMake(135.5, 141)];
  [bezier3Path moveToPoint: CGPointMake(223.5, 256)];
  [bezier3Path addCurveToPoint: CGPointMake(170, 227) controlPoint1: CGPointMake(205.17, 255) controlPoint2: CGPointMake(168.8, 247.8)];
  [bezier3Path addCurveToPoint: CGPointMake(181, 168.5) controlPoint1: CGPointMake(171.2, 206.2) controlPoint2: CGPointMake(177.83, 179.33)];
  [bezier3Path addCurveToPoint: CGPointMake(190.5, 156.5) controlPoint1: CGPointMake(183.17, 164.17) controlPoint2: CGPointMake(188.1, 155.7)];
  [bezier3Path moveToPoint: CGPointMake(156.5, 165)];
  [bezier3Path addCurveToPoint: CGPointMake(149, 214) controlPoint1: CGPointMake(155, 180.17) controlPoint2: CGPointMake(151.4, 211.2)];
  [bezier3Path moveToPoint: CGPointMake(161.5, 239.5)];
  [bezier3Path addCurveToPoint: CGPointMake(166.5, 168.5) controlPoint1: CGPointMake(161.5, 231.5) controlPoint2: CGPointMake(160.5, 183)];
  [bezier3Path moveToPoint: CGPointMake(143, 207.5)];
  [bezier3Path addCurveToPoint: CGPointMake(122.5, 236.5) controlPoint1: CGPointMake(130, 226.5) controlPoint2: CGPointMake(128.5, 231)];

  UIBezierPath* bezier4Path = [UIBezierPath bezierPath];
  [bezier4Path moveToPoint: CGPointMake(102.25, 243.25)];
  [bezier4Path addCurveToPoint: CGPointMake(68.75, 248.56) controlPoint1: CGPointMake(94.25, 234.75) controlPoint2: CGPointMake(79.15, 235.36)];
  [bezier4Path moveToPoint: CGPointMake(42.25, 254.75)];
  [bezier4Path addCurveToPoint: CGPointMake(66.25, 247.75) controlPoint1: CGPointMake(45.58, 250.92) controlPoint2: CGPointMake(55.05, 244.15)];
  [bezier4Path addCurveToPoint: CGPointMake(76.75, 251.75) controlPoint1: CGPointMake(77.45, 251.35) controlPoint2: CGPointMake(77.92, 251.92)];
  [bezier4Path moveToPoint: CGPointMake(180.75, 240.25)];
  [bezier4Path addCurveToPoint: CGPointMake(204.25, 240.25) controlPoint1: CGPointMake(185.75, 237.48) controlPoint2: CGPointMake(197.45, 233.6)];
  [bezier4Path addCurveToPoint: CGPointMake(209.49, 246.25) controlPoint1: CGPointMake(206.53, 242.48) controlPoint2: CGPointMake(208.23, 244.49)];
  [bezier4Path moveToPoint: CGPointMake(212.75, 253.25)];
  [bezier4Path addCurveToPoint: CGPointMake(209.49, 246.25) controlPoint1: CGPointMake(212.75, 252.21) controlPoint2: CGPointMake(212, 249.74)];
